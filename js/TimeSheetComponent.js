...
class TimeSheetComponent extends Component {
  ...
  fullfill(self) {
    ...
    els[1].value = els[1].value == "" || els[1].value == "00:00" ? "18:30" : els[1].value;
    els[2].value = els[2].value == "" || els[2].value == "00:00" ? "1:00" : els[2].value;
    els[3].value = els[3].value == "" || els[3].value == "00:00" ? "8:00" : els[3].value;
